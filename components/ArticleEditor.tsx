...
import { Banner } from '../src/lib/supabase';
  ...
  return (
              ...
              <div className="mb-4 pb-4 border-b border-gray-200 space-y-3">
                ...
                <div className="flex flex-wrap gap-2 items-center">
                  ...
                  <button
                    ...
                    className="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 text-sm font-medium rounded-lg transition-colors flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <BannerSelectorModal
      ...
      onSelect={(banner: Banner) => {
        // RichTextEditorにバナーを挿入（リンク付き・中サイズ固定）
        if (richTextEditorRef.current) {
          richTextEditorRef.current.insertBanner(banner.image_url, banner.link_url);
        }
